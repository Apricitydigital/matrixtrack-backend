...
const TEMPLATE_NAME = "new_matrix_track_daily_whatsapp_report";
        ...
        to_and_components: [
          {
            to: [normalizedPhone],
            components: {
              body_1: { type: "text", value: String(displayDate) },
              body_2: { type: "text", value: String(data.city.total) },
              body_3: { type: "text", value: String(data.city.present) },
              body_4: { type: "text", value: String(data.city.onLeave) },
              ...
              body_8: { type: "text", value: String(data.ramp.onLeave) },
              body_9: { type: "text", value: String(data.ramp.absent) },
              body_10: { type: "text", value: String(data.pmc.total) },
              body_11: { type: "text", value: String(data.pmc.present) },
              body_12: { type: "text", value: String(data.pmc.onLeave) },
              body_13: { type: "text", value: String(data.pmc.absent) },
            },
          },
        ],
      },
