...
const REPORT_IDS = ['zone-commissioner', ...[1, 2, 3, 4, 5].map(n => `zone-commissioner-zone-${n}`), 'daily-city-report', 'hms-daily-bulletin', 'daily-final-report', 'weekly-report', 'supervisor-daily-report'];
const validateId = id => {
