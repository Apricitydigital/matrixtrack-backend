// =========================================================================
// 🧪 PMC SWM PUNE DAILY BULLETIN REPORT - TEST RUNNER SCRIPT
// -------------------------------------------------------------------------
// This script triggers the new 39-variable template "pune_swm_daily_bulletin_report_hms".
// To test:
//   node testDailyBulletinPuneSWM.js <phone_numbers> [optional_date]
// Example:
//   node testDailyBulletinPuneSWM.js 918827232995,919131042937
// =========================================================================
...
async function main() {
  ...
  if (!phoneNumber) {
    ...
    console.log("\nUsage:");
    console.log("  node testDailyBulletinPuneSWM.js [phone_number] [optional_date_YYYY-MM-DD]");
    console.log("\nExamples:");
    console.log("  node testDailyBulletinPuneSWM.js");
    console.log(`  node testDailyBulletinPuneSWM.js ${DEFAULT_PHONE_NUMBER || "918827232995"} ${DEFAULT_DATE}`);
    process.exit(1);
  }

  console.log("\x1b[36m%s\x1b[0m", "--------------------------------------------------");
  console.log("\x1b[36m%s\x1b[0m", "🚀 PMC SWM Pune Daily Bulletin WhatsApp Test Script (39-Var Template)");
  console.log("\x1b[36m%s\x1b[0m", "--------------------------------------------------");
