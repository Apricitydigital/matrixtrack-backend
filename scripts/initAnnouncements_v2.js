...
const pool = new Pool({
  ...
  ssl: false, // Disable SSL for local initialization script
});

const testConnectionAndCreate = async () => {
    try {
        console.log("Checking database connection (Local Script - No SSL)...");
        ...
        CREATE TABLE IF NOT EXISTS announcements (
            ...
            target_role VARCHAR(50) DEFAULT 'supervisor',
